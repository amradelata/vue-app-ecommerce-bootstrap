<template>
  <div class="checkOut container">
    ...
    <div v-if="totalPrice" class="finaltotalPrice">
      <span>SHOPPING CART</span>
      <router-link to="/cart" class="btn btn-info block">Back to Cart</router-link>
      <ul>
        <li v-for="(item, i) in this.$store.state.cart" :key="i" class="media m-5 liItem">
          ...
          <div class="media-body">
            ...
            <h5
              style="color:#006fcc; display:inline-block; margin-left: 35px"
            >{{ item.productPrice + " EGP"}}</h5>
